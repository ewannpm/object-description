<template>
    ...
    <div class="righter">
      <div class="apis" v-for="item in nodeOptions" :key="item.title">
        <span class="title">{{item.title}}</span>
        <ul class="options">
          <li class="option" v-for="option in item.options" :key="option.index" @click="lightNode(option)">{{option.name}}</li>
        </ul>
      </div>
    </div>
</template>
